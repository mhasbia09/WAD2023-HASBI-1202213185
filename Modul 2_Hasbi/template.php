...
//    echo $pesan_error = "Nilai tidak boleh kosong";
//} else {
//    $konverter_tinggi_badan = $tinggi_badan / 100;
//    $konverter_berat_badan = $berat_badan / 100;
//    $hasil = $konverter_tinggi_badan / ($konverter_berat_badan * $konverter_berat_badan);
//    echo $hasil;
//}
// **********************  2  ************************** 
                ...
                <div class="card-body">
                    ...
                    if (isset($_POST["submit"])) {
                        ...
                        if(empty($tinggi_badan || $berat_badan)) {
                            ...
                            $konverter_tinggi_badan = $tinggi_badan / 100;
                            $hasil = $berat_badan / ($konverter_tinggi_badan * $konverter_tinggi_badan);
                        } if ($hasil <= 18.4) {
                            echo "Underweight";
                        } elseif ($hasil >= 18.4 && $hasil <= 24.9) {
                            echo "Normal";
                        } elseif ($hasil >= 24.9 && $hasil <= 39.9) {
                            echo "Overweight";
                        } else {
                            echo "Obese";
                        }
                        echo "/n Hasil = $hasil </br>";
                    } 
                    ?>
                    <!--  **********************  4  **************************     -->
